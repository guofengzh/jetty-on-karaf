 ...
 */
public class AetherBasedResolver2File {

    private static final Log LOG = LogFactory.getLog( AetherBasedResolver2File.class );
     ...
     */
    public AetherBasedResolver2File( final MavenConfiguration configuration )
